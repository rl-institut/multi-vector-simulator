...
- Renaming CAPEX_FIX = "capex_fix" into C_DEVELOPMENT = "Cost_development" (#347)
- Renaming CAPEX_VAR = "capex_var" into C_SPECIFIC = "cost_specific" (#347)
- Renaming OPEX_FIX = "opex_fix" into C_OM = "cost_om" (#347)
- Renaming OPEX_VAR = "opex_var" into P_DISPATCH = "p_dispatch" (#347)
