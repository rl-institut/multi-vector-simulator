...
class output_processing():
    def evaluate_dict(dict_values):
        ...
        for sector in ['electricity', 'heat']:
            ...
            results_timeseries.to_excel(dict_values['simulation_settings']['path_output_folder'] + '/'+ results_timeseries_output_file)
            ...
            plots.flows(dict_values['simulation_settings'], dict_values['project_data'], results_timeseries, sector, 14)
            plots.flows(dict_values['simulation_settings'], dict_values['project_data'], results_timeseries, sector, 365)

        # plot the capacities and the annuity costs
        plots.capacities(dict_values['simulation_settings'],dict_values['project_data'],capacities)
        plots.costs(dict_values['simulation_settings'],dict_values['project_data'],annuity_costs)
