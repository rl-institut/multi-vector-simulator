...
* Electricity Grid + PV ([data](tests/benchmark_test_inputs/AB_grid_PV/)/[pytest](tests/test_benchmark_scenarios.py:63)): Maximum use of PV to serve the demand and the rest is compensated from the grid
