        ...
        for asset_name in ['PV plant', 'Wind plant']:
            if asset_name in dict_values:
                ...
                if use == 'verify':
                    ...
                    function(dict_values['settings'], dict_values[asset_name][sub_name], file_path, asset_name)
            ...
            if demand_type in dict_values:
                ...
                for demand_key in dict_values['electricity_demand']:
                    ...
                    if use == 'verify':
                        ...
                        # receive data and write it into dict_values
                        function(dict_values['settings'], dict_values[demand_type][demand_key], file_path, demand_key)
        return
