...
pv_dem_ts = base64.b64encode(
    open("../MVS_outputs/input_timeseries_Habor_kW.png", "rb").read()
)
pv_inp_ts = base64.b64encode(
    open("../MVS_outputs/input_timeseries_PV plant (mono)_kW.png", "rb").read()
)
el_flows_14 = base64.b64encode(
    open("../MVS_outputs/Electricity_flows_14_days.png", "rb").read()
)
el_flows_365 = base64.b64encode(
    open("../MVS_outputs/Electricity_flows_365_days.png", "rb").read()
)
op_add_caps = base64.b64encode(
    open("../MVS_outputs/optimal_additional_capacities.png", "rb").read()
)
pv_inv_flow = base64.b64encode(
    open("../MVS_outputs/PV plant (mono) bus flows.png", "rb").read()
)
...
app.layout = html.Div(
    [
        html.Div(
            ...
            children=[
                html.Img(
                    id="mvslogo", src="assets/logo-eland-original.jpg", width="370px"
                ),
        ...
        html.Div(
            ...
            children=[
                html.Div(
                    [
                        html.Span("Project name   : ", style={"fontWeight": "bold"}),
                        f"{projectName}",
                    ]
                ),
                html.Br([]),
                html.Div(
                    [
                        html.Span("Scenario name  : ", style={"fontWeight": "bold"}),
                        f"{scenarioName}",
                    ]
                ),
            ],
            ...
            [
                html.Div(
                    [
                        ...
                        html.Iframe(
                            srcDoc=open("assets/proj_map", "r").read(),
                            width="70%",
                            height="700",
                        ),
                    ],
        ...
        html.P(
            ...
            style={"marginLeft": "50px", "textAlign": "justify", "fontSize": "40px",},
        ),
        html.Img(
