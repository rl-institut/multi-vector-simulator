...
def standby_consumption(model,bus_electricity,bus_H2,electrolyser,standby_sink,efficiency):
    """
    ...
    model.stanby_consumption_constraint = po.Constraint(model.TIMESTEPS, rule=standby_rule)
    return model
