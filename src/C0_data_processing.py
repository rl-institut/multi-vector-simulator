...
def receive_timeseries_from_csv(settings, dict_asset, type):
    ...
    input_sequences_folder = os.path.join(os.path.dirname(
        os.path.dirname(settings["path_input_folder"])), "sequences")
    file_path = os.path.join(input_sequences_folder, file_name)
